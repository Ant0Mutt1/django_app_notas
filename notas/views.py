...
class EtiquetaCreate(LoginRequiredMixin, CreateView):
    model = Etiqueta
...
class EtiquetaList(LoginRequiredMixin, ListView):
    model = Etiqueta
...
class EtiquetaDelete(LoginRequiredMixin, DeleteView):
    model = Etiqueta
...
class NotaDetalle(LoginRequiredMixin, DetailView):
    model = Nota
...
class EtiquetaUpdate(LoginRequiredMixin, UpdateView):
    model = Etiqueta
    form_class = EtiquetaForm
...
class NotaBuscar(LoginRequiredMixin, View):
